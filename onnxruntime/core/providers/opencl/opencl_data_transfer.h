...
class OpenCLDataTransfer : public IDataTransfer {
 ...
 public:
  ...
  Status CopyTensor(const Tensor& src, Tensor& dst, int exec_queue_id) const;
  ...
  Status CopyTensorNCHWToImage2D(const Tensor& src, const Image2D& dst, const Image2DDesc& desc) const;
